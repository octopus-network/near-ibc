...
use ibc::relayer::ics18_relayer::context::RelayerContext;
use ibc::relayer::ics18_relayer::error::RelayerError;
use ibc::signer::Signer;
use ibc::Height;
use ibc_proto::google::protobuf::Any;
use near_sdk::env;

impl RelayerContext for IbcContext<'_> {
    /// Returns the latest height of the chain.
    fn query_latest_height(&self) -> Result<Height, RelayerError> {
        Ok(Height::new(env::epoch_height(), env::block_height()).expect(""))
    }
